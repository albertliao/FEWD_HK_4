...
var startKeys=[32];//An array of keys to press to start the game, read the instructions in the index to determine what keycodes should go here
var eggsMissed=0;
var score=0;
...
$(document).ready(function(){
	...
	$("#egg-drop-game").on("animationEnd webkitAnimationEnd",".egg",function(){
		...
		var basketRightEdge=basketLeftEdge+parseInt($("#basket").width());
		...
		// You may found that this event was not triggered, this is because there is no "transition" on the .egg-left and .egg-right css.
		$(this).parent().remove();
		eggsMissed++;
